---
title: "Master LTREB Biomass Merged R Notebook"
author: Alina Drebin
output: html_notebook
---

This notebook describes the merging process between the Master AGB data and the 2014 tree inventory. Currently only includes Live and Dead and excludes Sapling
```{r}
getwd()
```
...
```{r}
write_csv(new_master, path = "../output/Master_AGB_data_for_UMBS_IMS_tree_list.csv")
```
